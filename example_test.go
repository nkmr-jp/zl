...
func ExampleSetVersion() {
	...
	// Output:
	// {"severity":"DEBUG","caller":"zl/zl.go:88","message":"INIT_LOGGER","version":"v1.0.0","console":"Severity: DEBUG, Output: ConsoleAndFile, File: ./log/example-set-version_v1.0.0.jsonl"}
